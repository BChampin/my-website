			...
			<div class="container">
				...
				<div class="row">
					<div class="card">
						...
						<div class="card-tabs">
							<ul class="tabs tabs-fixed-width">
								<li class="tab"><a href="#la_fb">Facebook</a></li>
								<li class="tab"><a class="active" href="#la_ig">Instagram</a></li>
								<li class="tab"><a href="#la_tw">Twitter</a></li>
							</ul>
						</div>
						<div class="card-content grey lighten-4">
							...
							<div id="la_ig">IG</div>
							<div id="la_tw">
								<a class="twitter-timeline" data-lang="fr" data-width="1200" data-height="600" data-dnt="true" data-theme="dark" href="<?php echo($ENV['TWITTER_WIDGET']); ?>">Tweets by bastienchampin</a>
